...
import {
accountSettingsProfileDetailsRequest,
accountSettingsEmailRequest,
accountSettingsPasswordRequest,
accountSettingsProfileDetailsData,
accountEmailData,
accountSettingsPasswordData,
accountSettingsAdditionalSettingsData,
accountSettingsAdditionalSettingsRequest
} from '../../shared/Types';
import {
accountSettingsUpdateProfileDetails,
accountSettingsUpdateEmail,
accountSettingsUpdatePassword,
accountSettingsUpdateAdditionalSettings
...
export const putAccountSettingsProfileDetails = (req: accountSettingsProfileDetailsRequest, res: Response) => {
    const data: accountSettingsProfileDetailsData = req.body.profileDetails;
    const response = accountSettingsUpdateProfileDetails(data);
...
export const putAccountSettingsEmail = (req: accountSettingsEmailRequest, res: Response) => {
    ...
    const response = accountSettingsUpdateEmail(data);
    res.send(JSON.stringify(response))
    res.status(OK).end();
}
export const putAccountSettingsPassword = (req: accountSettingsPasswordRequest, res: Response) => {
    ...
    const response = accountSettingsUpdatePassword(data);
    res.send(JSON.stringify(response))
    res.status(OK).end();
}
export const putAccountSettingsAdditionalSettings = (req: accountSettingsAdditionalSettingsRequest, res: Response) => {
    ...
    const response = accountSettingsUpdateAdditionalSettings(data);
    res.send(JSON.stringify(response))
    res.status(OK).end();
}